...
<AssignmentsDate />. You can also watch our blog and tumblr for a post verifying
...
Pinch hits are posted on the blog, tumblr, exchange Discord, and potentially on
Dreamwidth. Pinch hit deadlines are established as they are claimed and may fit
outside of the other exchange deadlines.
...
1. **We review tag nominations to make sure they fit our guidelines.** Tags
   which do not fit our guidelines are posted on the Discord server, blog, and
   tumblr, and noted on the nominations spreadsheet so that they can be updated.

...
12. You must comment on gifts you receive by Creator reveals, with a comment
    ...
    [FAQs: Help! I didn't get a comment!](./faqs#no-comment) for more
    information on comments and commenting requirements.
...
15. **These rules are non-exhaustive.** While we have attempted to be thorough,
    ...
    specific situations, questions, or issues, please see the [FAQs](./faqs) or

...
sometimes used in place of the `Prompt` field and sometimes in conjunction with.
...
If your gifter has questions they can always reach out to you on anon (if you
have them on) or get in contact with a moderator so we can get more details.
...
- [Kink List](https://wiki.f-list.net/Kink_Information)<br />
  <span className="inlineNote">this is an extensive kink list from a furry
  website intended to help furry roleplayers match; proceed with caution if this
  could squick you.</span>

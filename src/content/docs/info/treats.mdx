...
![Allow anyone to gift me works on](../../../assets/images/giftsettingon.png)
...
![Additional Treat Tags](../../../assets/images/treattags.png)
...
![Allow anyone to gift me works off](../../../assets/images/giftsettingoff.png)
...
3. This year's collection is listed in the `Post to Collections / Challenges`
   box.
4. You list all the recipients who you'd like to receive the work as a treat in
   the `Gift this work to` box.

![How to Post a Treat](../../../assets/images/posttreat.png)
